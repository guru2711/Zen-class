...
var continent = "Asia";
var asia = data.filter((e) => e.region === continent);
console.log(asia);


var strength = data.filter((e) => e.population < 200000);
console.log(strength);

data.forEach((e) => console.log(e.name + " / " + e.capital + " / " + e.flag));

var total = [];
data.forEach((e) => total.push(e.population));

var total_pop = total.reduce((acc, prev) => acc + prev);
console.log("TOTAL POPULATION OF WORLD IS :" + total_pop);
